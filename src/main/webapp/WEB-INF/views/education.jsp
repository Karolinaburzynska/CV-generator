            ...
            <div class="row">
                ...
                <div>
                    ...
                    <div class="col-lg-2" data-aos="fade-up">
                        <form method="post" action='<c:url value="/education/${title.id}" />'>
                            <input class="btn btn-danger pull-left" type="submit" value="Delete education"
                                   id="searchButton">
                        </form>
                    </div>
                    <p>____________</p>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10">
                                    <input class="form-control" type="text" name="fieldOfStudy"
